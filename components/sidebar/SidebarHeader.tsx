...
export default function SidebarHeader({ onNewDMClick }: SidebarHeaderProps) {
    ...
    return (
        <div className="flex items-center justify-between px-4 h-14 bg-[var(--color-header)] shrink-0">
            <div className="flex items-center space-x-3">
                ...
                <div className="text-white font-bold text-[var(--text-md)] hidden lg:block">ChatSphere</div>
            </div>
            ...
            <div className="flex items-center space-x-2">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-48 bg-[var(--color-bg-surface)] text-[var(--color-text-primary)] border-[var(--color-border)]">
