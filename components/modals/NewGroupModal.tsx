...
export default function NewGroupModal() {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
            <DialogContent className="bg-[#0D1117]/95 backdrop-blur-xl border border-white/10 text-slate-100 max-w-md p-0 overflow-hidden rounded-3xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)]">
                    ...
                    <AnimatePresence mode="wait" initial={false}>
                        {step === 1 ? (
                            ...
                            >
                                ...
                                {/* Selected Preview — Avatars with cancel icon */}
                                {selected.length > 0 && (
